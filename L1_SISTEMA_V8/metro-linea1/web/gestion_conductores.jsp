...
<div class="container py-4">
    <div class="d-flex align-items-center justify-content-between flex-wrap bg-white rounded shadow-sm p-3 mb-4">
        ...
        <div class="text-center flex-grow-1">
            ...
            <div class="text-secondary" style="font-size:0.98em;">
                <fmt:formatDate value="${now}" pattern="dd/MM/yyyy"/>
            </div>
            <div style="font-size:1.2em; font-weight:bold; margin-top:10px;">UNNA TRANSPORTE</div>
        </div>
        <div class="d-flex align-items-center gap-3">
            <img src="images/${sessionScope.foto}" alt="Foto de perfil" class="rounded-circle border border-2 border-primary" width="54" height="54" style="object-fit:cover;">
        ...
        <table class="table table-striped table-hover align-middle table-custom">
            ...
            <c:forEach var="c" items="${listaConductores}">
                <tr>
                    ...
                    <td>
                        <c:out value="${c.antiguedad}"/>
                        <%-- Calcula antigüedad (años, meses, días) desde el servlet y mándalo como c.antiguedad (String) --%>
                    </td>
