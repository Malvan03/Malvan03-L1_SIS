...
<%
    ...
    if (usuario == null || !"CONDUCTOR".equals(rol)) {
        response.sendRedirect("login.jsp");
        return;
    }

    LocalDate fechaActual = LocalDate.now();
    int numeroDeNotificaciones = 5; // Reemplaza esto con el valor real
%>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <div class="header">
        <div class="left-section">
            ...
            <span>BIENVENIDO <%= usuario.toUpperCase() %></span>
        </div>
        <div class="right-section d-flex align-items-center">
            <div class="fecha"><%= fechaActual %></div>
            <!-- ... dentro del div class="right-section d-flex align-items-center" ... -->
    ...
    <!-- Tarjetas para el conductor sin botones de editar/eliminar -->
    <div class="grid">
        <div class="card-option">
            <a href="mis_turnos.jsp">
                <img src="assets/images/turnos.jpg" alt="Ver Mis Turnos">
                <h5>Ver Mis Turnos</h5>
            </a>
        </div>

        <div class="card-option">
            <a href="solicitar_cambio.jsp">
                <img src="assets/images/cambio.jpg" alt="Solicitar Cambio">
                <h5>Solicitar Cambio</h5>
            </a>
        </div>

        <div class="card-option">
            <a href="estado_solicitudes.jsp">
                <img src="assets/images/historial.jpg" alt="Historial de Cambios">
