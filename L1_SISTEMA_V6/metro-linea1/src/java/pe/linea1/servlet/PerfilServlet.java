    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if ("actualizarPerfil".equals(accion)) {
                ...
                session.setAttribute("usuario", usuario); // Refresca datos de sesión
                exito = true;
            ...
            if ("actualizarFoto".equals(accion)) {
                ...
                if (fotoPart != null && fotoPart.getSize() > 0) {
                    // Guarda la imagen en /images (ajusta ruta real si usas un servidor de archivos)
                    ...
                    file.getParentFile().mkdirs(); // Crea carpetas si faltan
                    fotoPart.write(rutaAbsoluta);

                    // Actualiza usuario en BD y sesión
