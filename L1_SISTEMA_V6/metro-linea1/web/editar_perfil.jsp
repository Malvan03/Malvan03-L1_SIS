...
<head>
    <meta charset="UTF-8">
    <title>Editar Perfil | Metro Línea 1</title>
...
<div class="perfil-container">
    <div class="text-center mb-3">
        ...
        <h4><%= nombre %> <%= apellidoPaterno %> <%= apellidoMaterno %></h4>
        <span class="badge bg-info text-dark"><%= rol %></span>
    </div>
    <form action="PerfilServlet" method="post" autocomplete="off">
        <!-- Puedes agregar aquí inputs para apellidos si deseas permitir editarlos -->
        <div class="mb-3">
