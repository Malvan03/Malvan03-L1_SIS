    ...
    <div class="ver-turnos-header row align-items-center mb-4 px-2">
        <div class="col-md-8 col-12">
            ...
            <div class="mb-1" style="font-size:1.15em; color:#2376d9;">
                <strong>
                    <i class="bi bi-person-badge"></i> ${sessionScope.nombre}
                </strong>
            </div>
            ...
            <div class="mb-1 text-muted" style="font-size:1em;">
                <i class="bi bi-credit-card"></i> <span class="fw-bold">DNI:</span> ${sessionScope.dni}
            </div>
        </div>
        <div class="col-md-4 col-12 d-flex align-items-center justify-content-md-end justify-content-start mt-md-0 mt-3 gap-3">
            <img src="images/${sessionScope.foto}" alt="Foto de perfil" class="rounded-circle border border-2 border-success shadow" width="70" height="70" style="object-fit:cover;">
