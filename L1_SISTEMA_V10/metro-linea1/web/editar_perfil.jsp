...
<div class="perfil-container">
    <div class="text-center mb-3">
        <img src="images/<%= usuario.getFotoPerfil() != null && !usuario.getFotoPerfil().isEmpty() ? usuario.getFotoPerfil() : "default_avatar.png" %>"
             class="perfil-foto mb-2" id="fotoPerfilVista" alt="Foto de perfil"
             style="width:120px;height:120px;border-radius:50%;object-fit:cover;border:2px solid #2376d9;">
    ...
    <%-- Mensajes de éxito/error desde el servlet --%>
    <%
        String mensaje = (String) request.getAttribute("mensaje");
        Boolean exito = (Boolean) request.getAttribute("exito");
        if (mensaje != null && !mensaje.isEmpty()) {
    %>
        <div class="alert alert-<%= (exito != null && exito) ? "success" : "danger" %>"><%= mensaje %></div>
    <%
        }
    %>
    ...
    <div class="mt-3 text-center">
        <a href="home_<%= "ADMINISTRADOR".equalsIgnoreCase(rol) ? "admin" : "conductor" %>.jsp" class="btn btn-outline-secondary">Volver al inicio</a>
    </div>
</div>
